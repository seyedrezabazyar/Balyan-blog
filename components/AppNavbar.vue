    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-16">
        ...
        <div class="hidden md:flex items-center space-x-8 space-x-reverse">
          ...
          <!-- Auth Section - Only show if store is available -->
          <div v-if="authStore && authStore.isLoggedIn" class="flex items-center gap-4">
            <!-- User Dropdown -->
    ...
    >
      <div v-if="isOpen" class="md:hidden bg-white border-t border-gray-100">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          <!-- Mobile Auth Section -->
          <div v-if="authStore && authStore.isLoggedIn" class="border-t border-gray-200 pt-4 mt-4">
